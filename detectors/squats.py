...
class SquatDetector(BaseExercise):
    ...
    def process(self, landmarks):
        ...
        left_vis = landmarks[self.LEFT_KNEE].visibility           # vis = visibility
        ...
        if left_vis > right_vis:
            ...
            hip_idx, knee_idx, ankle_idx, shoulder_idx = self.RIGHT_HIP, self.RIGHT_HIP, self.RIGHT_ANKLE, self.RIGHT_SHOULDER
